...
const {
  ...
  verifyRefreshToken, revokeAllTokens, decodeToken, getTokenTTL,
} = require('../services/jwtService');
const { blacklistToken, incrementLoginAttempts, resetLoginAttempts } = require('../config/redis');
...
// ── GET /api/auth/me ──────────────────────────────────────────────
const me = (req, res) => res.json({ success: true, data: { user: req.user.toPublic() } });
